...
public class Main
{
    public static void main(String[] args)
    {
        ...
        System.out.println("============= Kertas - Batu - Gunting =============");
        ...
        {
            System.out.println("Pilih tangan: (0: Kertas, 1: Batu, 2: Gunting)");
            ...
            System.out.println("Anda memilih: " + gameKBG.pilihanTangan(pilihTangan));

            int randomKomputer = new Random().nextInt(3);
            System.out.println("Komputer memilih: " + gameKBG.pilihanTangan(randomKomputer));
